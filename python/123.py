...
# task-5 check whether a number is prime or not 
...
# print("\nTask 1: Prime Number Rows")
# print(prime_rows)

# A[:, 1::2] = A[::-1, 1::2]

# print("\nTask 2: Alternate Columns Reversed")
# print(A)

# np.fill_diagonal(A, 0)
# print("\nTask 3: Diagonal Replaced with Zeros")
# print(A)
# border_sum = np.sum(A[0, :]) + np.sum(A[-1, :]) + np.sum(A[1:-1, 0]) + np.sum(A[1:-1, -1])
# print("\nTask 4: Sum of Border Elements")
# print(border_sum)
# rotate = np.rot90(A, -1)

# print("\nTask 5: Matrix Rotated 90 Degrees Clockwise")
# print(rotate)
...
# square = np.sqrt(arr)
# perfect_square = np.sum(square == square.astype(int))
...
# new_arr[new_arr % 7 == 0] = np.sqrt(new_arr[new_arr % 7 == 0])

# print("\nAfter Replacing Multiples of 7")
# print(new_arr)

# sorted_arr = np.sort(arr)

# gap = np.diff(sorted_arr)

# print("\nLargest Gap =", np.max(gap))
...
import numpy as np
A = np.random.randint(50, 251, (30,5))
